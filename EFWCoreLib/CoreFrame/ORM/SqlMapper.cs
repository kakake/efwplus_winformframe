...
#pragma warning restore 612, 618
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        public SqlMapper.IMemberMap GetMember(string columnName)
        {
            ...
            {
                var property = _properties.FirstOrDefault(p => string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName, StringComparison.Ordinal))
                  ?? _properties.FirstOrDefault(p => string.Equals(p.GetCustomAttributes(false).OfType<ColumnAttribute>().FirstOrDefault().FieldName, columnName, StringComparison.OrdinalIgnoreCase));
